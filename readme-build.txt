...
1. Using a command prompt/line, move to the directory team07/Build/ which contains all the files for this application. This is done through the command "cd 'enter directory here'" regardless of platform.
